...
Node.js >= 18
npm >= 9
Działający backend laravel_api dostępny pod http://localhost:8000
...
bash# 1. Sklonuj repozytorium i przejdź do folderu frontendu
cd todo-app
...
envVITE_BASE_URL=http://localhost:8000
...
bash# Zbuduj aplikację do folderu dist/
npm run build
...
Powiązane projekty
Backend API: laravel_api — Laravel 11 + Sanctum
